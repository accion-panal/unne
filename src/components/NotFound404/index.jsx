...
const NotFoundError = () => {
    const ErrorImg = 'https://res.cloudinary.com/dvdb33uyj/image/upload/v1686667150/Projects/unne/img/Error404/Unne_Error_404_eg3lm8.png';
    return (
        <div className="flex justify-center items-center container h-screen mx-auto">
            <div className="grid grid-cols-1 sm:grid-cols-2 ml-4">
                <div className="col-span-2 sm:col-auto">
                    ...
                    <h2 className='text-orange-500 text-2xl xl:text-5xl uppercase'>
                        404 - Page Not Found
                    </h2>
                    <p className='my-5'>
